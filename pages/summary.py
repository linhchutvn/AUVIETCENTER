...
def clean_and_parse_json(text):
    ...
    # 1. Trích xuất khối {...} ra khỏi các đoạn văn bản rườm rà
...
# ---------------------------------------------------------
    ...
    with col_detail:
        ...
        with tab2:
            ...
            # --- XỬ LÝ VÀ IN BÀI MẪU + BẢNG ĐIỂM CHUẨN MỰC TỪ AI ---
            ...
            if 90 <= model_wc <= 130:
                ...
                model_word_feedback = "Độ dài được kiểm soát hoàn hảo, nằm trọn trong biên độ tiêu chuẩn."
